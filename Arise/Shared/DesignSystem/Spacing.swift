...
extension View {
    func arisePadding(_ edges: Edge.Set = .all, _ size: CGFloat = AriseSpacing.medium) -> some View {
        self.padding(edges, size)
    }
    
    func ariseScreenPadding() -> some View {
        self.padding(AriseSpacing.screenPadding)
    }
    
    func ariseCardPadding() -> some View {
        self.padding(AriseSpacing.cardPadding)
    }
    
    func ariseButtonPadding() -> some View {
        self.padding(.horizontal, AriseSpacing.buttonPadding)
            .padding(.vertical, AriseSpacing.small)
    }
}

// MARK: - Spacing View
struct AriseSpace: View {
    let height: CGFloat
    let width: CGFloat
...
extension View {
    func ariseCornerRadius(_ radius: CGFloat = AriseCornerRadius.medium) -> some View {
